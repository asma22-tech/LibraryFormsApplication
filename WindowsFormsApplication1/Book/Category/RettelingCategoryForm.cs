...
{
    public partial class RettelingCategoryForm : Form
    {
        public RettelingCategoryForm()
        {
            InitializeComponent();
        }
        ...
        private void RettelingCategoryForm_Load(object sender, EventArgs e)
        {
            using(SqlConnection con = new SqlConnection(constring))
            using (SqlCommand cmd = con.CreateCommand())
            {
                SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM Book where Category = 'Retteling';", con);
